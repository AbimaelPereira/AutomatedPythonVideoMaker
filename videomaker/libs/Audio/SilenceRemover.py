...
PRESETS = {
    ...
    "tight": {
        ...
        "keep_silence":      80,  # ms  — margem para decaimento natural do som
    },
    # Balanceado — uso geral, narração normal
    "normal": {
        "silence_thresh":  -50,
        "min_silence_len":  900,
        "keep_silence":    110,   # ms  — margem maior para preservar consoantes finais
    },
    ...
    "relaxed": {
        ...
        "keep_silence":    140,   # mantém bordas maiores
    },
}
