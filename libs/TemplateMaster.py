...
class TemplateMaster:
    ...
    def narration_subtitles(self, params = None):
        ...
        params_default.update(params or {})
        ...
        tts = EdgeTTS({
            ...
            "voice_id": params_default.edge_tts.voice,
            "rate": params_default.edge_tts.rate,
    ...
    def headline(self, params = None):
        ...
        output_path = os.path.join(self.output_folder, self.slug + ".png")
